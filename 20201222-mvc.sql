...
--
-- Table structure for table `gat_article_qna`
--

DROP TABLE IF EXISTS `gat_article_qna`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_article_qna` (
...
--
-- Dumping data for table `gat_article_qna`
--

LOCK TABLES `gat_article_qna` WRITE;
/*!40000 ALTER TABLE `gat_article_qna` DISABLE KEYS */;
/*!40000 ALTER TABLE `gat_article_qna` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `gat_comment_qna`
--

DROP TABLE IF EXISTS `gat_comment_qna`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gat_comment_qna` (
...
--
-- Dumping data for table `gat_comment_qna`
--

LOCK TABLES `gat_comment_qna` WRITE;
/*!40000 ALTER TABLE `gat_comment_qna` DISABLE KEYS */;
INSERT INTO `gat_comment_qna` VALUES (1,1,'safdsfs','4','2020-12-17 09:57:04');
/*!40000 ALTER TABLE `gat_comment_qna` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `grp_board` VALUES (58,'100','QnA','#6F809A','관리자','고객센터 게시판','1','1','2','2','1','2020-12-17');
...
INSERT INTO `grp_calendar` VALUES (2,'2020-12-09','2020-12-12','sadfsaf','admin'),(3,'2020-12-17','2020-12-19','asdfadfsafsafsf','admin'),(4,'2020-12-10','2020-12-17','asfdsaf','admin');
...
--
-- Table structure for table `grp_survey`
--

DROP TABLE IF EXISTS `grp_survey`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `grp_survey` (
  `survey_id` int NOT NULL AUTO_INCREMENT,
  `survey_status` char(10) DEFAULT NULL,
  `survey_result` char(10) DEFAULT NULL,
  `survey_startDate` date DEFAULT NULL,
  `survey_endDate` date DEFAULT NULL,
  `survey_maker` char(5) DEFAULT NULL,
  `survey_title` varchar(100) DEFAULT NULL,
  `survey_example` varchar(300) DEFAULT NULL,
  `survey_ex_cnt` varchar(50) DEFAULT NULL,
  `survey_regdate` datetime DEFAULT NULL,
  PRIMARY KEY (`survey_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `grp_survey`
--

LOCK TABLES `grp_survey` WRITE;
/*!40000 ALTER TABLE `grp_survey` DISABLE KEYS */;
INSERT INTO `grp_survey` VALUES (12,'설문진행중','공개','2020-12-17','2020-12-19','관리자','연차사용 유효기간에 대한 설문조사','만족한다.|불만족한다.|관심없다.|','5|3|1|','2020-12-17 15:19:02'),(13,'설문진행중','공개','2020-12-21','2020-12-24','관리자','연차사용 유효기간에 대한 설문조사','만족한다.|불만족이다.|관심없다.|나중에 확인하겠다.|','0|0|0|0|','2020-12-21 11:42:15');
/*!40000 ALTER TABLE `grp_survey` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-12-22  9:12:09
